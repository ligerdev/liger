...
problems_list = ['DTLZ2','DTLZ3','DTLZ4','DTLZ5','DTLZ6','DTLZ7',
                 'ZDT1','ZDT2','ZDT3','ZDT4','ZDT5','ZDT6',
                 'WFG1','WFG2','WFG3','WFG4','WFG5','WFG6','WFG7','WFG8','WFG9',
                 'LZ09_F1','LZ09_F2','LZ09_F3','LZ09_F4','LZ09_F5','LZ09_F6','LZ09_F7','LZ09_F8','LZ09_F9']
problems_min_obj = [2,2,2,2,2,2,
                    2,2,2,2,2,2,
                    2,2,2,2,2,2,2,2,2,
                    2,2,2,2,2,3,2,2,2]
problems_max_obj = [9999,9999,9999,9999,9999,9999,
                    2,   2,   2,   2,   2,   2,
                    9999,9999,9999,9999,9999,9999,9999,9999,9999,
                    2,2,2,2,2,3,2,2,2]        
problems_min_nvar= [12,12,12,12,12,12,
                    30,30,30,10,11,10,
                    24,24,24,24,24,24,24,24,24,
                    30,30,30,30,30,30,30,30,30]
problems_max_nvar= [9999,9999,9999,9999,9999,9999,
                    9999,9999,9999,9999,9999,9999,
                    9999,9999,9999,9999,9999,9999,9999,9999,9999,
                    9999,9999,9999,9999,9999,9999,9999,9999,9999]                                     

# 'NSGAII' is currently the "master" node which contains manual changes.
algorithms_list = ['DE','GDE3','GGA','PAES','PSO','SMPSO','SSGA']
...
ThingsList = ['ScatterPlot', 'MScatterPlot']
...
for StringName in ThingsList:
    ...
    # 	op_fsrc  = env.get_template('t_externalnodefactorysource.cpp')
        ...
        dialog_path = '../src/plugins/'+plugin_name+'/forms/'
        ...
        op_frmhead = env.get_template('t_viznodeformhead.h')
        op_frmsrc  = env.get_template('t_viznodeformsource.cpp')
        op_frmui   = env.get_template('t_viznodeform.ui')
    elif ClassType==5:
    ...
    fname_op_fmhead= dialog_path + StringName + 'Form.h'
    fname_op_fmsrc = dialog_path + StringName + 'Form.cpp'
    fname_op_fmui  = dialog_path + StringName + 'form.ui'
