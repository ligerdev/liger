...
class LIGER_JSON_EXPORT JsonValue
{
public:
    enum Type {
        Null =  0x0,
...
class LIGER_JSON_EXPORT JsonValueRef
{
public:
...
class LIGER_JSON_EXPORT JsonValuePtr
{
    JsonValue value;
public:
...
class LIGER_JSON_EXPORT JsonValueRefPtr
{
...
class LIGER_JSON_EXPORT JsonArray
{
public:
    JsonArray();
...
class LIGER_JSON_EXPORT JsonObject
{
public:
    JsonObject();
...
class LIGER_JSON_EXPORT JsonDocument
{
public:
