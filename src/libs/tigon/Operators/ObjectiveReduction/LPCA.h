...
class LIGER_TIGON_EXPORT LPCA : public IObjectiveReduction
{
    DECLARE_CLASS(Tigon::Operators::LPCA)

public:
    LPCA();
    LPCA(Tigon::Representation::IPSet* ipset);
    virtual ~LPCA();
...
private:
    void initialise();
    PCABasedObjectiveReduction* m_objred;
};
