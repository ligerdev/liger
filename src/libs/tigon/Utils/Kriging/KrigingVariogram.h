...
public:
    ...
    void calculateEmpiricalVariogram(const TCVectorReal& dist,
                                     const TCVectorReal& Zx);
    void calculateEmpiricalVariogram(const TVector<TVector<double>>& x,
    ...
    void assignVariogramData(const TVector<TVector<double>>& x,
                             const TVector<double>& y);
    double alpha()   const;
    double paramC()  const;
    double nugget()  const;
    ...
    /// Utilities
    TCVectorReal interiorPointSolver(const TMatrixReal& Q, const TCVectorReal& c,
