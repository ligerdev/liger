...
SphericalVariogram::SphericalVariogram(const TVector<TVector<double>>& xx,
                                       const TVector<double>& y, double nug)
...
int SphericalVariogram::lsqLM(const TCVectorReal& y_input,
                              const TCVectorReal& x_input,
                              const TCVectorReal& W, double& c, double& r)
{
    rHistory.clear();
    cHistory.clear();
    errHistory.clear();
