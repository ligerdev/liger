...
REGISTER_IFUNCTION_FACTORY(CTP2)
...
CTP2::CTP2()
{
    ...
    TP_defineNOutputs(3);
    TString name("CTP2");
    TString description("CTP2 benchmark problem. A constrained problem where.\n"
                        ...
                        "The constraint makes some portions of the uncontrained"
                        " Pareto-optimal region infeasible.\n"
                        ...
                        " Pareto optimal\n."
                        "The difficulty of the problem is lower when compared"
                        " with CTP3-CTP5, since a substancial part of the"
                        " Pareto-optimal region is unconstrained.\n");
