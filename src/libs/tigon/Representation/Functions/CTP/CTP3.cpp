...
REGISTER_IFUNCTION_FACTORY(CTP3)
...
CTP3::CTP3()
{
    ...
    TP_defineNOutputs(3);
    TString name("CTP3");
    TString description("CTP3 benchmark problem. A constrained problem where.\n"
