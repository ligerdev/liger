...
**
** This is a modified version of ZDT4.h from jMetalCpp version 1.0.1
** Filename: ZDT4.h
...
class LIGER_METAL_EXPORT ZDT4 : public IProblem {
private:
...
public:
    ZDT4(QString solutionType, int numberOfVariables = 10);
