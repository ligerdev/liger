...
**
** This is a modified version of ZDT3.cpp from jMetalCpp version 1.0.1
** Filename: ZDT3.cpp
** Path:     jMetalCpp/problems/
** Date:     12/03/2013
** Original Version Author/s:  Antonio J. Nebro, Juan J. Durillo
****************************************************************************/
#include <metal/problems/ZDT3.h>

ZDT3::ZDT3(QString solutionType, int numberOfVariables) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in ZDT3::ZDT3(QString, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in ZDT3::ZDT3(QString, int) : Unknown SolutionType.");
    }
