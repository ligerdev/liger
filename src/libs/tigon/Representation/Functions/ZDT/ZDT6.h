...
**
** This is a modified version of ZDT6.h from jMetalCpp version 1.0.1
** Filename: ZDT6.h
...
class LIGER_METAL_EXPORT ZDT6 : public IProblem {
private:
...
public:
    ZDT6(QString solutionType, int numberOfVariables = 10);
