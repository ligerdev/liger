...
**
** This is a modified version of ZDT3.h from jMetalCpp version 1.0.1
** Filename: ZDT3.h
...
class LIGER_METAL_EXPORT ZDT3 : public IProblem {
private:
...
public:
    ZDT3(QString solutionType, int numberOfVariables = 30);
