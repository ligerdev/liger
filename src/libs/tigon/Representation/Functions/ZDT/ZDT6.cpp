...
**
** This is a modified version of ZDT6.cpp from jMetalCpp version 1.0.1
** Filename: ZDT6.cpp
** Path:     jMetalCpp/problems/
** Date:     12/03/2013
** Original Version Author/s:  Antonio J. Nebro, Juan J. Durillo
****************************************************************************/
#include <metal/problems/ZDT6.h>

ZDT6::ZDT6(QString solutionType, int numberOfVariables) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in ZDT6::ZDT6(QString, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in ZDT6::ZDT6(QString, int) : Unknown SolutionType.");
    }
...
void ZDT6::evaluate(Solution *solution) {
    ...
    m_fx[0] = 1.0 - exp(-4.0*x1) * pow(sin(6.0*M_PI*x1), 6.0);
    double g = evalG(x);
