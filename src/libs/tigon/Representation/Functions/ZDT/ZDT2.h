...
**
** This is a modified version of ZDT2.h from jMetalCpp version 1.0.1
** Filename: ZDT2.h
...
class LIGER_METAL_EXPORT ZDT2 : public IProblem{
private:
...
public:
    ZDT2(QString solutionType, int numberOfVariables = 30);
