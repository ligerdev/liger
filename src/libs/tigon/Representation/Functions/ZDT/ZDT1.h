...
**
** This is a modified version of ZDT1.h from jMetalCpp version 1.0.1
** Filename: ZDT1.h
...
class LIGER_METAL_EXPORT ZDT1 : public IProblem {
private:
...
public:
    ZDT1(QString solutionType, int numberOfVariables = 30);
