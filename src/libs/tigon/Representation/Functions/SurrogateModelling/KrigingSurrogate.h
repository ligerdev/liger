...
**
****************************************************************************/
#ifndef KRIGINGSURROGATE_H
#define KRIGINGSURROGATE_H
...
class LIGER_TIGON_EXPORT KrigingSurrogate : public IFunction
{

public:
    KrigingSurrogate();
    KrigingSurrogate(KrigingSPtr model);
    virtual ~KrigingSurrogate();
