...
**
****************************************************************************/
#include <tigon/Operators/Evaluators/WFG/WFG2.h>
...
WFG2::WFG2(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in WFG2::WFG2(QString, int, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in WFG2::WFG2(QString, int, int, int) : Unknown SolutionType.");
    }
...
void WFG2::evaluate(Solution *solution) {
    ...
    const vector<double>& f = Problems::WFG2(z, k, nobj);
