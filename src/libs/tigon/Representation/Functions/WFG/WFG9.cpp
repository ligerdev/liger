...
**
****************************************************************************/
#include <tigon/Operators/Evaluators/WFG/WFG9.h>
...
WFG9::WFG9(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in WFG9::WFG9(QString, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in WFG9::WFG9(QString, int, int) : Unknown SolutionType.");
    }
...
void WFG9::evaluate(Solution *solution) {
    ...
    const vector<double>& f = Problems::WFG9(z, k, nobj);
