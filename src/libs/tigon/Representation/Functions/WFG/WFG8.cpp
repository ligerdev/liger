...
**
****************************************************************************/
#include <tigon/Operators/Evaluators/WFG/WFG8.h>
...
WFG8::WFG8(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in WFG8::WFG8(QString, int, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in WFG8::WFG8(QString, int, int, int) : Unknown SolutionType.");
    }
...
void WFG8::evaluate(Solution *solution) {
    ...
    const vector<double>& f = Problems::WFG8(z, k, nobj);
