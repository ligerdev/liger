...
**
****************************************************************************/
#include <tigon/Operators/Evaluators/WFG/WFG4.h>
...
WFG4::WFG4(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in WFG4::WFG4(QString, int, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in WFG4::WFG4(QString, int, int, int) : Unknown SolutionType.");
    }
...
void WFG4::evaluate(Solution *solution) {
    ...
    const vector<double>& f = Problems::WFG4(z, k, nobj);
