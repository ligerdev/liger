...
**
****************************************************************************/
#include <tigon/Operators/Evaluators/WFG/WFG5.h>
...
WFG5::WFG5(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in WFG5::WFG5(QString, int, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in WFG5::WFG5(QString, int, int, int) : Unknown SolutionType.");
    }
...
void WFG5::evaluate(Solution *solution) {
    ...
    const vector<double>& f = Problems::WFG5(z, k, nobj);
