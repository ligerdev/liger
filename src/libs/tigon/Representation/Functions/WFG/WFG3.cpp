...
**
****************************************************************************/
#include <tigon/Operators/Evaluators/WFG/WFG3.h>
...
WFG3::WFG3(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in WFG3::WFG3(QString, int, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in WFG3::WFG3(QString, int, int, int) : Unknown SolutionType.");
    }
...
void WFG3::evaluate(Solution *solution) {
    ...
    const vector<double>& f = Problems::WFG3(z, k, nobj);
