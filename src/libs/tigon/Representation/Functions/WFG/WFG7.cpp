...
**
****************************************************************************/
#include <tigon/Operators/Evaluators/WFG/WFG7.h>
...
WFG7::WFG7(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in WFG7::WFG7(QString, int, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in WFG7::WFG7(QString, int, int, int) : Unknown SolutionType.");
    }
...
void WFG7::evaluate(Solution *solution) {
    ...
    const vector<double>& f = Problems::WFG7(z, k, nobj);
