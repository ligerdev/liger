...
**
****************************************************************************/
#include <tigon/Operators/Evaluators/WFG/WFG6.h>
...
WFG6::WFG6(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in WFG6::WFG6(QString, int, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in WFG6::WFG6(QString, int, int, int) : Unknown SolutionType.");
    }
...
void WFG6::evaluate(Solution *solution) {
    ...
    const vector<double>& f = Problems::WFG6(z, k, nobj);
