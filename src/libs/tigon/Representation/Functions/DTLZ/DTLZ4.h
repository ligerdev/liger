...
**
** This is a modified version of DTLZ4.h from jMetalCpp version 1.0.1
** Filename: DTLZ4.h
...
class LIGER_METAL_EXPORT DTLZ4 : public IProblem {
public:
    DTLZ4(QString solutionType, int numberOfVariables = 12, int numberOfObjectives = 3);
