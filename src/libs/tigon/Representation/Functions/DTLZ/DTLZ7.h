...
**
** This is a modified version of DTLZ7.h from jMetalCpp version 1.0.1
** Filename: DTLZ7.h
...
class LIGER_METAL_EXPORT DTLZ7 : public IProblem {
public:
    DTLZ7(QString solutionType, int numberOfVariables = 12, int numberOfObjectives = 3);
