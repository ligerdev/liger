...
**
** This is a modified version of DTLZ5.h from jMetalCpp version 1.0.1
** Filename: DTLZ5.h
...
class LIGER_METAL_EXPORT DTLZ5 : public IProblem {
public:
    DTLZ5(QString solutionType, int numberOfVariables = 12, int numberOfObjectives = 3);
