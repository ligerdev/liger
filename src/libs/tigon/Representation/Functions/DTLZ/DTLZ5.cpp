...
**
** This is a modified version of DTLZ5.cpp from jMetalCpp version 1.0.1
** Filename: DTLZ5.cpp
** Path:     jMetalCpp/problems/
** Date:     12/03/2013
** Original Version Author/s:  Antonio J. Nebro, Juan J. Durillo
****************************************************************************/
#include <metal/problems/DTLZ5.h>

DTLZ5::DTLZ5(QString solutionType, int numberOfVariables, int numberOfObjectives) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in DTLZ5::DTLZ5(QString, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in DTLZ5::DTLZ5(QString, int, int) : Unknown SolutionType.");
    }
