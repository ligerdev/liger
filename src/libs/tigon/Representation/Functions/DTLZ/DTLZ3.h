...
**
** This is a modified version of DTLZ3.h from jMetalCpp version 1.0.1
** Filename: DTLZ3.h
...
class LIGER_METAL_EXPORT DTLZ3 : public IProblem {
public:
    DTLZ3(QString solutionType, int numberOfVariables = 12, int numberOfObjectives = 3);
