...
**
** This is a modified version of LZ09_F1.h from jMetalCpp version 1.0.1
** Filename: LZ09_F1.h
** Path:     jMetalCpp/core/
** Date:     12/03/2013
...
class LIGER_METAL_EXPORT LZ09_F1 : public IProblem {
public:
    LZ09_F1(QString solutionType, int ptype=21, int dtype=1, int ltype=21);
