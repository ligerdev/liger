...
**
** This is a modified version of LZ09_F4.h from jMetalCpp version 1.0.1
** Filename: LZ09_F4.h
...
class LIGER_METAL_EXPORT LZ09_F4 : public IProblem {
public:
    LZ09_F4(QString solutionType, int ptype=21, int dtype=1, int ltype=24);
