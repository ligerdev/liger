...
**
** This is a modified version of LZ09_F6.h from jMetalCpp version 1.0.1
** Filename: LZ09_F6.h
...
class LIGER_METAL_EXPORT LZ09_F6 : public IProblem {
public:
    LZ09_F6(QString solutionType, int ptype=31, int dtype=1, int ltype=32);
