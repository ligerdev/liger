...
**
** This is a modified version of LZ09_F1.cpp from jMetalCpp version 1.0.1
** Filename: LZ09_F1.cpp
** Path:     jMetalCpp/core/
** Date:     12/03/2013
** Original Version Author/s:  Antonio J. Nebro, Juan J. Durillo
****************************************************************************/
#include <metal/problems/LZ09_F1.h>

/**
 * Constructor
 */
LZ09_F1::LZ09_F1(QString solutionType, int ptype, int dtype, int ltype) {
    ...
    if (m_lowerLimit == 0) {
        throw MetalException("Error in LZ09_F1::LZ09_F1(QString, int, int, int) : Out of memory.");
    }
    ...
    if (solutionType.compare("BinaryReal") == 0)
        ...
        throw MetalException("Error in LZ09_F1::LZ09_F1(QString, int, int, int) : Unknown SolutionType.");
    }
