...
**
** This is a modified version of LZ09_F8.h from jMetalCpp version 1.0.1
** Filename: LZ09_F8.h
...
class LIGER_METAL_EXPORT LZ09_F8 : public IProblem {
public:
    LZ09_F8(QString solutionType, int ptype=21, int dtype=4, int ltype=21);
