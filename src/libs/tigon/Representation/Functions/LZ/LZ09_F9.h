...
**
** This is a modified version of LZ09_F9.h from jMetalCpp version 1.0.1
** Filename: LZ09_F9.h
** Path:     jMetalCpp/core/
** Date:     12/03/2013
...
class LIGER_METAL_EXPORT LZ09_F9 : public IProblem {
public:
    LZ09_F9(QString solutionType, int ptype=22, int dtype=1, int ltype=22);
