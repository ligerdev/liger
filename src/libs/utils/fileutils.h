...
LIGER_UTILS_EXPORT QDebug operator<<(QDebug dbg, const Utils::FileName &c);

QT_END_NAMESPACE

namespace Utils {

class LIGER_UTILS_EXPORT FileName : private QString
{
public:
    FileName();
...
class LIGER_UTILS_EXPORT FileUtils {
public:
...
class LIGER_UTILS_EXPORT FileReader
{
...
class LIGER_UTILS_EXPORT FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
    FileSaverBase();
...
class LIGER_UTILS_EXPORT FileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
class LIGER_UTILS_EXPORT TempFileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
QT_BEGIN_NAMESPACE
LIGER_UTILS_EXPORT uint qHash(const Utils::FileName &a);
QT_END_NAMESPACE
