...
#include <QString>
#include <QColor>
#include <QWidget> // Patch for Qt5.5

namespace Utils {

class LIGER_UTILS_EXPORT TipContent
{
protected:
    TipContent();
...
class LIGER_UTILS_EXPORT ColorContent : public TipContent
{
public:
...
class LIGER_UTILS_EXPORT TextContent : public TipContent
{
public:
...
class LIGER_UTILS_EXPORT WidgetContent : public TipContent
{
public:
