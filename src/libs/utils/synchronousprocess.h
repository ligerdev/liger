...
struct LIGER_UTILS_EXPORT SynchronousProcessResponse
{
    enum Result {
...
LIGER_UTILS_EXPORT QDebug operator<<(QDebug str, const SynchronousProcessResponse &);

class LIGER_UTILS_EXPORT ExitCodeInterpreter : public QObject
{
    Q_OBJECT
public:
...
class LIGER_UTILS_EXPORT SynchronousProcess : public QObject
{
    Q_OBJECT
public:
    enum Flags {
