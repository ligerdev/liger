...
namespace Utils {
class LIGER_UTILS_EXPORT FadingPanel : public QWidget
{
    Q_OBJECT
...
class LIGER_UTILS_EXPORT FadingWidget : public FadingPanel
{
    Q_OBJECT
public:
...
class LIGER_UTILS_EXPORT DetailsButton : public QAbstractButton
{
    Q_OBJECT
