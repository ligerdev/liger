...
class LIGER_UTILS_EXPORT QtcProcess : public QProcess
{
    Q_OBJECT
...
public:
    ...
    class LIGER_UTILS_EXPORT Arguments
    {
    public:
     ...
     */
    class LIGER_UTILS_EXPORT ArgIterator {
    public:
    ...
    class LIGER_UTILS_EXPORT ConstArgIterator {
    public:
...
// except on Windows.
LIGER_UTILS_EXPORT unsigned long qPidToPid(const Q_PID qpid);
