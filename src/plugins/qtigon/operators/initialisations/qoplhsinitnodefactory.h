...
class QTIGON_EXPORT QOpLHSInitNodeFactory : public Designer::IProcessNodeFactory
{
    Q_OBJECT

public:
    QOpLHSInitNodeFactory();

    Designer::IProcessNode* createProcessNode();
    QString className() { return QString("QTigon::QOpLHSInitNode"); }
    bool isSelected();
    void unSelect();
