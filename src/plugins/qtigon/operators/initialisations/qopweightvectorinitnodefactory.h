...
**
****************************************************************************/
#ifndef QOPWEIGHTVECTORINITNODEFACTORY_H
#define QOPWEIGHTVECTORINITNODEFACTORY_H
...
class QTIGON_EXPORT QOpWeightVectorInitNodeFactory : public Designer::IProcessNodeFactory
{
    Q_OBJECT

public:
    QOpWeightVectorInitNodeFactory();

    Designer::IProcessNode* createProcessNode();
    QString className() { return QString("QTigon::QOpWeightVectorInitNode"); }
    bool isSelected();
    void unSelect();
...
#endif // QOPWEIGHTVECTORINITNODEFACTORY_H