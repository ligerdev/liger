...
class QTIGON_EXPORT QOpUserDefinedInitNodeFactory : public Designer::IProcessNodeFactory
{
    Q_OBJECT

public:
    QOpUserDefinedInitNodeFactory();

    Designer::IProcessNode* createProcessNode();
    QString className() { return QString("QTigon::QOpUserDefinedInitNode"); }
    bool isSelected();
    void unSelect();
