...
class QTIGON_EXPORT QAlgopNSGAIINodeFactory : public Designer::IProcessNodeFactory
{
    Q_OBJECT

public:
    QAlgopNSGAIINodeFactory();

    Designer::IProcessNode* createProcessNode();
    QString className() { return QString("QTigon::QAlgopNSGAIINode"); }
    bool isSelected();
	void unSelect();
