...
class QTIGON_EXPORT QAlgoNSGAIIINodeFactory : public Designer::IProcessNodeFactory
{
    Q_OBJECT

public:
    QAlgoNSGAIIINodeFactory();

    Designer::IProcessNode* createProcessNode();
    QString className() { return QString("QTigon::QAlgoNSGAIIINode"); }
    bool isSelected();
	void unSelect();
