...
//#include "linenumberfilter.h" /// Disabled - Yiming Yan
...
TextEditorPlugin::TextEditorPlugin()
  : m_settings(0),
    m_editorFactory(0),
//    m_lineNumberFilter(0), /// Disabled - Yiming Yan
...
bool TextEditorPlugin::initialize(const QStringList &arguments, QString *errorMessage)
{
    ...
    //    m_lineNumberFilter = new LineNumberFilter; /// Disabled - Yiming Yan
    //    addAutoReleasedObject(m_lineNumberFilter); /// Disabled - Yiming Yan
