...
// Patch required to work with Q5.5
...
static const char kTextBlockMimeType[] = "application/vnd.liger.blocktext";
static const char kVerticalTextBlockMimeType[] = "application/vnd.liger.vblocktext";
...
void BaseTextEditorWidget::uppercaseSelection()
{
    ...
    transformSelection(&QString_toUpper); // Patch required to work with Qt5.5
}

void BaseTextEditorWidget::lowercaseSelection()
{
    // transformSelection(&QString::toLower);
    transformSelection(&QString_toLower); // Patch required to work with Qt5.5
}
...
QMimeData *BaseTextEditorWidget::createMimeDataFromSelection() const
{
    if (d->m_inBlockSelectionMode) {
        ...
        /*
          ...
          including indentation in the liger.blocktext mimetype.
        */
...
void BaseTextEditorWidget::transformSelection(TransformationMethod method)
{
    ...
    QString transformedText = method(text); // Patch required to work with Q5.5
...
void BaseTextEditorWidget::transformBlockSelection(TransformationMethod method)
{
    ...
    for (;;) {
        ...
        if (startPos < endPos) {
            ...
            const QString &transformedText = method(d->m_document->textAt(startPos, endPos - startPos)); // Patch required to work with Q5.5
