...
#include "ui_pythontempaltewizardpage.h"
...
PythonTempalteWizardPage::PythonTempalteWizardPage(QWidget *parent) :
    QWizardPage(parent),
    ui(new Ui::PythonTempalteWizardPage)
{
    ui->setupUi(this);
...
PythonTempalteWizardPage::~PythonTempalteWizardPage()
{
    delete ui;
}

QString PythonTempalteWizardPage::content() const
{
    QString content;
    QFile templateFile(":/pythontemplate/template/t_pythontemplate");
...
QString PythonTempalteWizardPage::functionName() const
{
