...
static QString compilerString()
{
    ...
    if (_MSC_VER >= 1910)
        return QLatin1String("MSVC ") + QString::number(2017);
    if (_MSC_VER >= 1900)
        return QLatin1String("MSVC ") + QString::number(2015);
    if (_MSC_VER >= 1800)
        return QLatin1String("MSVC ") + QString::number(2013);
    if (_MSC_VER >= 1700)
        return QLatin1String("MSVC ") + QString::number(2012);
    if (_MSC_VER >= 1600)
        return QLatin1String("MSVC ") + QString::number(2010);
    if (_MSC_VER >= 1500)
        return QLatin1String("MSVC ") + QString::number(2008);
    if (_MSC_VER >= 1400)
        return QLatin1String("MSVC ") + QString::number(2005);
#endif
...
#endif
    return tr("Liger %1%2").arg(QLatin1String(Constants::IDE_VERSION_LONG),
