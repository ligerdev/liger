/****************************************************************************
 * This is a customised copy of qt creator main window.
 * Changes made to qt creator core plugin:
 * 1. Removed VcsManager
 * 2. Removed Locator
 * 3. Disabled some modules to fit our needs.
 *
 ****************************************************************************/
