...
win32 {
    ...
    for(imagesize, IMAGE_SIZE_LIST) {
        eval(image$${imagesize}.files = images/logo/$${imagesize}/Liger_logo.png)
        eval(image$${imagesize}.path = $$LIGER_BUILD_TREE/share/icons/hicolor/$${imagesize}x$${imagesize}/apps)
