    ...
    : QDialog(parent)
{
    ...
    setWindowIcon(QIcon(QLatin1String(Constants::ICON_LIGERLOGO_128)));

    setWindowTitle(tr("About Liger"));
    ...
    logoLabel->setPixmap(QPixmap(QLatin1String(Constants::ICON_LIGERLOGO_48)));
