...
/// \note The following files are disable by Liger Dev Team
...
void EditorManager::splitNewWindow(Internal::EditorView *view)
{
    ...
    splitter->setAttribute(Qt::WA_QuitOnClose, false); // don't prevent Liger from closing
...
void EditorManager::rootDestroyed(QObject *root)
{
    ...
    if (!newActiveRoot) {
        ...
        // or there might be a Liger toplevel activated that doesn't have editor windows
